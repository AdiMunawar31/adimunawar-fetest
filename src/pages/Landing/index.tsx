          ...
          <div className='lg:flex'>
            <div className='relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12'>
              <p className='sm:text-lg text-gray-700 dark:text-gray-300 lg:w-11/12'>
                ...
                contacts, transforming it into a delightful breeze. Say hello to
                a world where communication flows effortlessly, and organization
                becomes a second nature. With our intuitive and powerful tools,
                you'll experience a new level of ease in managing and
